...
9. While these approaches were developed especially for vector data, there is a more universal approach available to you as well. If your geometric dataframe inherits the `sf` class (which it likely does), you can use `geom_sf()`, which detects the geometry column automatically and allows us to use our familiar ggplot aesthetic tricks.
...
10. Even in the more complex setup, where we work with background images and
