...
include_graphics("https://raw.githubusercontent.com/krisrs1128/stat436_s24/refs/heads/main/notes/figure/hclust_cutting.png")
```
...
See a great example of a genomic hierarchical clustering tree here: https://observablehq.com/embed/@d3/tree-of-life?cells=viewof+showLength%2Cchart
...
include_graphics("https://raw.githubusercontent.com/krisrs1128/stat436_s24/refs/heads/main/notes/figure/hclust_algo.png")
```
...
include_graphics("https://raw.githubusercontent.com/krisrs1128/stat436_s24/refs/heads/main/notes/figure/hclust_merge1.png")
```
...
include_graphics("https://raw.githubusercontent.com/krisrs1128/stat436_s24/refs/heads/main/notes/figure/hclust_merge2.png")
```

```{r, fig.cap = "We can continue this process...", echo = FALSE, out.width = 600}
include_graphics("https://raw.githubusercontent.com/krisrs1128/stat436_s24/refs/heads/main/notes/figure/hclust_merge3.png")
```

```{r, fig.cap = "... and eventually we will construct the entire tree.", echo= FALSE, out.width = 600}
include_graphics("https://raw.githubusercontent.com/krisrs1128/stat436_s24/refs/heads/main/notes/figure/hclust_merge_pre_final.png")
```

```{r, echo = FALSE, out.width = 600}
include_graphics("https://raw.githubusercontent.com/krisrs1128/stat436_s24/refs/heads/main/notes/figure/hclust_merge_final.png")
```
