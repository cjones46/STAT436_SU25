...
7. Gradually decreasing slopes in the ACF suggest long-run, overall trends. This is because if
there is a trend, the current value tends to be very correlated with the recent
past. It's possible to have both an overall trend and seasonality within that, in which case the
ACF function has bumps where the seasonal correlation is strongest.
