...
Also notice the subtle introduction of a new concept; the double-sided slider! Providing a 2-length vector to the `values` argument; that is, `c(1928, 2020)`; will define an upper and lower bound on the slider that the user can tinker with. The consequence of this is that calling `input$year` down in the server now returns a 2-length vector for the locations of both ends, such that `input$year[1]` refers to the lower bound and `input$year[2]` refers to the upper bound.
