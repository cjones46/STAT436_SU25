...
8. Once the graph is constructed, there is the question of how the graph layout
...
10. You can see more examples of what this algorithm does to toy datasets in this
...
The `step_umap` command is available through the embed package. (*You may also have to install the `irlba` package with `install.packages("irlba", type = "source")`).
