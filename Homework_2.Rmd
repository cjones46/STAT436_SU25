...
This "Think Tank"-like problem asks you to consider the pros and cons of an existing interactive visualization: the main "flower plot" at: https://www.oecd.org/en/data/tools/well-being-data-monitor/better-life-index.html.

**Cameron update 6/25/2026: They changed the link on me, apologies to anyone doing this problem prior to that date! I've updated the link.**
...
**c)** One interactive option the graph offers is the ability to sort the countries alphabetically versus by rank. Why do you think the author included these options? What question is each sorting order better at answering?
